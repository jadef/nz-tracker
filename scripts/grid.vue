...
<div class="grid__wrapper">
  <card :card="card" class="grid__card" v-for="(card, index) in cards" :key="index"></card>
</div>  
</template>
...
module.exports = {
  ...
  methods: {
    getRecords: function() {
      ...
      var collectionURL = "https://api.jsonbin.io/v3/c/5f83f9ee7243cd7e824e36d8/bins";
    ...
    getAllCards: function(records) {
      records.forEach(
        record => this.getCard(record.record)
      );
    },
    getCard: function (id) {
      var self = this;
